...
public class CreateCampaignsPage {
	...
	public void CreateCampaign(String camName,String date,String tarAudi,String campsts,String desI,String tarsize) {
		campaignNameInput.sendKeys(camName);
		dateInput.sendKeys(date);
		targetAudienceInput.sendKeys(tarAudi);
		campaignStatusInput.sendKeys(campsts);
		descriptionInput.sendKeys(desI);
		targetSizeInput.sendKeys(tarsize);
