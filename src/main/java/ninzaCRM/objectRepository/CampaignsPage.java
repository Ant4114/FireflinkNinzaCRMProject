...
public class CampaignsPage extends WebdriverUtlity {
	...
	/**
	 * This method will go crate campaign page 
	 */
	public void createCampaignClick() {
		createCampaignBtn.click();
	}
	public void searchCampaign(String campdata,String campinfo) {
		handleDropdown(campaignDropdown,campdata);
		searchInput.sendKeys(campinfo);
	}
