...
public class VerifyPurchaseOrderWithUpdatedProduct {
   ...
   String sub=row.getCell(3).toString();
   String ContactName=row.getCell(4).toString();
   String billAdd=row.getCell(5).toString();
   String shipAdd=row.getCell(6).toString();
   String billBox=row.getCell(7).toString();
   String shipBox=row.getCell(8).toString();
   String billCity=row.getCell(9).toString();
   String city=row.getCell(10).toString();
   String billState=row.getCell(11).toString();
   String state=row.getCell(12).toString();
   String billCode=row.getCell(13).toString();
   String postCode=row.getCell(14).toString();
   String billCoun=row.getCell(15).toString();
   String country=row.getCell(16).toString();
   String ProdName=row.getCell(17).toString();
